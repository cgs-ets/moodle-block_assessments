...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('block_assessments/dbassessmentprocstaff', get_string('dbassessmentprocstaff', 'block_assessments'), get_string('dbassessmentprocstaff_desc', 'block_assessments'), ''));
